          ...
          <div className="sample-grid" style={{ display:'grid', gridTemplateColumns:'repeat(2, 1fr)', gap:16, alignItems:'start' }}>
            ...
            <div>
              ...
              <div style={cardStyle(0.05)}>
                ...
                {[
                  { sev:'critical',  color:C.red,    bg:'#fdf2f2', border:'#f5c6c6', label:'🔴 Critical', title:'Site loads in 6.1s — compress hero image', desc:'Compress your hero image to under 150kb using a free tool like Squoosh.app. This alone cuts your load time from 6.1s to under 2.5s — Google starts ranking you higher and fewer visitors leave before the page appears.' },
                  { sev:'critical',  color:C.red,    bg:'#fdf2f2', border:'#f5c6c6', label:'🔴 Critical', title:'No CTA above the fold — add one button', desc:'Add one button in the first thing visitors see when they land on your page. Something specific like "Start your programme today" — sites that do this get 3.5× more people taking action.' },
                  { sev:'important', color:C.yellow, bg:'#fefdf2', border:'#f5e6a3', label:'🟡 Important', title:'TikTok engagement 63% below average', desc:'Your top 3 videos get 4× more views than the rest and they all open with a direct question. Copy that pattern in every post — based on your data, this alone could bring your interaction rate from 1.8% to 4%+.' },
                  { sev:'important', color:C.yellow, bg:'#fefdf2', border:'#f5e6a3', label:'🟡 Important', title:'Meta description missing — add one now', desc:'Google shows a short description under your website name in every search result. Yours is missing, so Google writes it automatically — usually badly. Write one clear sentence describing what you do and who it's for. Takes 10 minutes.' },
                  { sev:'quickwin', color:'#1e8449', bg:'#f2fdf5', border:'#a9dfbf', label:'🟢 Quick Win', title:'Rename "Get Started" to something specific', desc:'Your main button says "Get Started" — that's too vague. Change it to something specific like "Start my coaching plan" — takes 2 minutes in your website editor and typically gets 15–30% more clicks.' },
                ].map((issue, i) => (
              ...
              <div style={accentCardStyle(0.12)}>
                ...
                {[
                  ...
                  { time:'This week (1–2 hrs)', action:'Compress your hero image to under 150kb using Squoosh.app (free), then ask your hosting provider to enable caching', impact:'Your page load time drops from 6.1s to under 2.5s — Google ranks faster sites higher' },
